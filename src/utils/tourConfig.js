...
export const dashboardTourSteps = [
  {
    ...
    popover: {
      ...
      description: 'This is your personalized dashboard where you can track your progress, investments, and opportunities.',
      position: 'bottom'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: '⚡ Quick Actions',
      description: 'Find opportunities to earn Karma Points and contribute to the community. Each action brings rewards!',
      position: 'left'
    }
  },
  {
...
export const projectInvolvementTourSteps = [
  {
    ...
    popover: {
      ...
      description: 'Share the projects you\'re involved with. This helps us connect you with relevant opportunities and partners.',
      position: 'right'
    }
  },
  {
    ...
    popover: {
      ...
      description: 'Provide comprehensive information about your projects. The more details you add, the better connections we can make!',
      position: 'left'
    }
  },
  {
    ...
    popover: {
      ...
      description: 'Specify how your project can collaborate with others. This helps in matching you with potential partners.',
      position: 'bottom'
    }
  }
];
...
export const ambassadorTourSteps = [
  {
    ...
    popover: {
      ...
      description: 'Join our ambassador program to earn rewards while helping grow the community. Special perks await active ambassadors!',
      position: 'bottom'
    }
  },
  {
...
export const startTour = (tourType, isEditMode = false) => {
  try {
    ...
    if (missingElements.length > 0) {
      console.warn('Some tour elements are missing:', missingElements.map(step => step.element));
