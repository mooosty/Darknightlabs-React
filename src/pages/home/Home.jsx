                        ...
                        <div className="hero_wrap">
                            <div className="hero_wws_wrap">
                                <div className="hero_left wws_left">
                                    ...
                                    {authDetails ? <Link to={ROUTER.profile} className='hero_btn'>To dashboard</Link> :
                    ...
                    <div className="about_main_wrap" id="about">
                        <div className="about_wrap" id="about">
                            ...
                            <div className="text_wrap">
                                <p>Darknight Labs is an NFT Strategy, Marketing and Partnership agency.
                                    Known for providing paradigm-shifting strategies to ensure optimal NFT
                                    drops by their partners, Darknight Labs is one of the most well-
                                    connected entities in the Web3 space, with hundreds of warm
                                    connections to founders and core team members from the very best
                                    projects, communities, VCs and brands in the space.</p>
                                <p>Our typical client is a Web2 brand or company that want to enter the NFT
                                    space in the most optimal way, without replicating the deadly mistakes
                                    (that we&apos;ve observed many major brands commit), or a Web3 project,
                                    either a crypto game, a defi platform, a tool or any other value-adding
                                    product, looking to tap into the NFT community the right way, while
                                    performing a successful mint.</p>
                                <p>In addition, through high level partners, Darknight Labs help their
                                    ...
                                    Web3 founders mastermind with the purpose of making Web3 founders
                                    with a great product and a healthy mindset synergize, cross-pollinate
                                    audiences, cross-integrate assets and utilities, and cross-market. The
                                    goal is to create the ultimate win-win Web3 ecosystem.</p>
                            </div>
                        </div>
                    </div>
