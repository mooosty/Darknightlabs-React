            ...
            <div className="project_edit_page_data">
                <div className="page_data">
                    <div className="page_header">
                        ...
                        {false && <button className="btn_gray" onClick={handleSaveChanges} disabled={projectSaveApiLoading}>
                            {(projectSaveApiLoading) ? <> <Loader loading={projectSaveApiLoading} isItForButton={true} /> <p>Save changes</p> </> : 'Save changes'}
                        </button>}
                        {true && <button className="btn_gray" onClick={handleAddProject} disabled={projectApiLoading}>
