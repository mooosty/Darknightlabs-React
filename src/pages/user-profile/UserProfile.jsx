...
import { closedEyeIcon, openEyeIcon, editIcon, sepratorImage, twitterIcon, discordIcon, telegramIcon, calendarBlankIcon, ThreeDots, } from "../../utils/constants/images";
...
const UserProfile = () => {
  ...
  //   }
  // };
  console.log(setTelegramUsername);
