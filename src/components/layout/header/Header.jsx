...
const Header = ({isSidebarOpen , setIsSidebarOpen}) => {
  ...
  const dropdownItems = [
    ...
    {
      label: (
        <button className="dropdown_tab logout_tab">
          <LogoutNavTabIcon />
          <span>Logout</span>
        </button>
      ),
      ...
      <div className="header_right">
        ...
        <div className="sidebar_btn">
          <div onClick={() => setIsSidebarOpen((prev) => !prev)}>
            <span style={{ display: "block", width: "24px", height: "2px", background: "white", marginBottom: "4px" }}></span>
            <span style={{ display: "block", width: "24px", height: "2px", background: "white", marginBottom: "4px" }}></span>
